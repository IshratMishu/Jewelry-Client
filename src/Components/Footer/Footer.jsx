        ...
        <div className="mt-28">
            ...
            <div className="flex items-center justify-between">
                <div className="space-y-4">
                    <Logo></Logo>
                    <p className="text-sm">Unleash the radiance of your inner beauty <br /> with our premium jewelry brand - a <br /> perfect blend of sophistication and style.</p>
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="">
                    <h3 className="text-lg font-medium mb-1 text-end">Subscribe to our newsletter</h3>
                    <div className="relative flex items-center cursor-pointer justify-end">
                        <input type="search" className="px-6 w-96 py-2 border border-[--secondary-color] focus:outline-none bg-[#FAFAF4]" placeholder="Your email address" />
